...
const DELAY_BETWEEN_REQUESTS = 5000; // 5 seconds to avoid rate limiting (increased from 2s)
const MAX_RETRIES = 3;
const INITIAL_RETRY_DELAY = 10000; // 10 seconds initial retry delay
...
// Call Gemini Vision API with retry mechanism
